...
export const testimonial_cards = [
  ...
  // },
  {
    ...
    image: HomeImages.Tanay,
    testament:
      "Jai Hind! “Maine socha na tha, yeh kaisa silsila, NSS ne diya pyaar ka rang, dosti ka sailaab, Har pal yaadgar, har lamha adhura na sahar, Ek anokha yaado ka khazana, ek naya manzar.” Toh kahani shuru hoti hai 2nd year me jab mujhe phele se hi nss me aana tha but kabhi socha nahi tha itna involve aur addicted hojauga isse, nss kya karta hai yeh phele se hi pata tha but actual me kya hai aur kaisa hai yeh 2 saal me jaana sikha aur samja, “Don’t judge a book by its cover” suits best for nss bahar se kitna bhi strict ya boring lagge but andar se vitna hi mazzedaar aur pyara hai but khair sabki bas ki baat nahi isse samajne ki!!😂 From not knowing the fullform of NSS in the recruitment to leading the NSS as a Council ufff kya hi rollercoaster journey thi🫶, Unfortunate bolo ya lucky bolo I had missed the first round of recruitment since I was out of town, but jab me vapas aaya me apne friends se",
    position: "Council",
    period: "(2023 - 24)",
  },
  {
